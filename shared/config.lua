...
Config.Key = 0xF3830D8E -- [J]

-- Player Experience Enhancements
Config.EnableNotifications = true -- Show notifications for interactions
Config.EnablePromptFeedback = true -- Play sound when prompt appears
Config.InteractionCooldown = 1000 -- Milliseconds between interaction changes
Config.PromptFadeDistance = 3.0 -- Distance at which prompt starts to fade
Config.EnableDistanceScaling = true -- Scale prompt visibility by distance

-- ox_target Menu Settings
Config.ShowAllInteractions = true -- Show all available interactions, or just the first one
Config.GroupSimilarInteractions = true -- Group interactions by category (sitting, sleeping, etc.)
Config.ShowPositionInLabel = true -- Show position (Left/Right/Middle) in interaction labels
...
Config.Notifications = {
    InteractionStarted = { type = 'success', message = 'Interaction started' },
    InteractionStopped = { type = 'inform', message = 'Interaction ended' },
    BannedArea = { type = 'error', message = 'You cannot interact here' },
    Cooldown = { type = 'inform', message = 'Wait a moment before changing interaction' }
}
